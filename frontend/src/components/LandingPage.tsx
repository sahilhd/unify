    ...
    <div className="bg-gradient-to-b from-gray-900 to-gray-800 min-h-screen flex flex-col">
      <nav className="flex justify-between items-center px-8 py-6">
        ...
        <div className="space-x-6">
          ...
          <button className="text-white hover:text-purple-400" onClick={() => window.open('https://github.com/your-org/your-repo', '_blank')}>GitHub</button>
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-12">
          ...
          <button className="px-8 py-3 bg-gray-700 hover:bg-gray-600 rounded text-lg font-semibold text-white shadow" onClick={() => window.open('https://github.com/your-org/your-repo', '_blank')}>View on GitHub</button>
        </div>
